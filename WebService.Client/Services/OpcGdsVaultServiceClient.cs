...
namespace Microsoft.Azure.IoTSolutions.OpcGdsVault.WebService.Client.Services {
    ...
    /// </summary>
    public class OpcGdsVaultServiceClient : IOpcGdsVaultService {
#if mist
        /// <summary>
        ...
        public OpcGdsVaultServiceClient(IHttpClient httpClient,
            IOpcGdsVaultConfig config, ILogger logger) {
