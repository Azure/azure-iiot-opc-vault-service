...
namespace Microsoft.Azure.IIoT.OpcUa.Api.Vault.v1.Models
{
    ...
    public partial class CreateNewKeyPairRequestApiModel
    {
        ...
        /// class.
        /// </summary>
        public CreateNewKeyPairRequestApiModel(string applicationId = default(string), string groupId = default(string), string certificateType = default(string), string subjectName = default(string), IList<string> domainNames = default(IList<string>), string privateKeyFormat = default(string), string privateKeyPassword = default(string))
        {
