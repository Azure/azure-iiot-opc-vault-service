...
namespace Microsoft.Azure.IIoT.OpcUa.Api.Vault.v1.Models
{
    ...
    public partial class FetchRequestResultApiModel
    {
        ...
        public FetchRequestResultApiModel(CertificateRequestState state, string requestId = default(string), string applicationId = default(string), string groupId = default(string), string certificateType = default(string), string signedCertificate = default(string), string privateKeyFormat = default(string), string privateKey = default(string), string authorityId = default(string))
        {
            RequestId = requestId;
