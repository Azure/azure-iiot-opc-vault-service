...
WORKDIR /src
COPY src/Microsoft.Azure.IIoT.WebApps.OpcUa.Vault.csproj src/
COPY NuGet.Config NuGet.Config
COPY *.props /
RUN dotnet restore --configfile NuGet.Config -nowarn:msb3202,nu1503 src/Microsoft.Azure.IIoT.WebApps.OpcUa.Vault.csproj
COPY . .
WORKDIR /src/src
