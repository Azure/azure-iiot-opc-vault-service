...
namespace Microsoft.Azure.IoTSolutions.OpcGdsVault.WebService.Client {
    ...
    public static class OpcGdsVaultServiceEx {
        ...
        public static Task<TwinRegistrationApiModel> GetEndpointAsync(
            this IOpcGdsVaultService service, string endpointId) =>
        ...
        public static Task<TwinRegistrationListApiModel> ListTwinsAsync(
            this IOpcGdsVaultService service, string continuation) =>
        ...
        public static async Task<IEnumerable<TwinRegistrationApiModel>> ListTwinsAsync(
            this IOpcGdsVaultService service, bool? onlyServerState = null) {
        ...
        /// <returns></returns>
        public static Task<ServerApiModel> FindServerAsync(this IOpcGdsVaultService service,
        ...
        public static async Task<IEnumerable<ServerInfoApiModel>> ListServersAsync(
            this IOpcGdsVaultService service) {
